...
const routes: Routes = [
  ...
  {path:'welcome/:id', component: WelcomeComponent, canActivate:[RouteGuardService]},     //you put id here to delete specific person
  ...
  {path:'edit-task/:id', component: EditTaskComponent},      //, canActivate:[RouteGuardService]},
  {path:'update/:id', component: UpdateuserComponent},      //you added this one as well            //this might be where unique constraint flow issue may start?
  {path:'adduser', component: AdduserComponent},                //you added this one
